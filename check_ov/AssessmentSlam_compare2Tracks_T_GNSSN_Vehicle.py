...
def main():
    ...
    # 配准前后的原始关键帧的初始位姿，以及经过配准后的车辆的关键帧位姿
    slam_types = ['Initial_KeyFrame_T_GNSSN_Vehicle', 'Registration_KeyFrame_T_GNSSN_Vehicle']
    slam_paths = [
        '/home/zhao/Data/tunnelData/data_2025220163953/OutputFile/initialT_NVehicle_OutputFile.txt',
        '/home/zhao/Data/tunnelData/data_2025220163953/OutputFile/registrationT_NVehicle_OutputFile.txt'
    ]
